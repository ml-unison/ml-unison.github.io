...
1. [Una libreta sobre creación de modelos y experimentos anidados](https://github.com/ml-unison/ml-unison.github.io/raw/main/ejemplos/hyperparameter-tuning-with-child-runs.ipynb)